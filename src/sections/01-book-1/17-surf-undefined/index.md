...
You will immediately see a <analogy>stack trace</analogy> in the **Debug Console** at the bottom. Your job is to understand the <analogy>error message</analogy>, read the stack trace to determine exactly where the error is, and then fix the error.
