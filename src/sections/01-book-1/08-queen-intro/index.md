...
Functions are the first major hurdle of learning software development. One of the main reasons is that you need to understand the difference between a <analogy>function definition</analogy> and running the function.
...
The key is understanding the problem, and then knowing the <analogy>algorithm</analogy> to solve it before you write any code.
