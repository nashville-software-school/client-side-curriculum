...
2. What <analogy>state</analogy> is being tracked in the application?
3. What <analogy>state</analogy> is persistent? Reverse engineer the data and their relationships and build an <analogy>ERD</analogy>.
4. What <analogy>state</analogy> is transient? Is there any <analogy>state</analogy> being tracked, but not permanently in the <analogy>API</analogy>?
5. What <analogy>event</analogy> listeners are used in this application? Which components have <analogy>event</analogy> listeners?
