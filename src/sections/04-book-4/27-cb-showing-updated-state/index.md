...
5. Once regenerated, the new order should appear in the <analogy>DOM</analogy>. Again, start with displaying a simple message with the order <analogy>number</analogy>. _(Did you <analogy>create</analogy> your **Orders** <analogy>module</analogy> yet to display HTML representations of orders?)_
