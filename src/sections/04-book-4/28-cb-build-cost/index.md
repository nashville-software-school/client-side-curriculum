...
If you want to <analogy>try</analogy> out something fun, display that cost on each HTML representation of the orders with the `toLocaleString()` method which will place a dollar sign, and commas in the correct location for each cost.
