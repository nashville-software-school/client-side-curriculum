...
In the animation below, you will see that there are logging messages that the HTML is being regenerated when the <analogy>state</analogy> is set, yet the radio buttons that the user selected are not selected.
