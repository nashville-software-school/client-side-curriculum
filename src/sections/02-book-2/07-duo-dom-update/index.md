...
The goals is to take that single HTML string that contains the 2 smaller chunks of HTML generated by **HeroList** and **VillainList** and dynamically update the <analogy>DOM</analogy> with it.

It will replace the existing `<h1>The Dynamite Duo</h1>` that you manually typed in earlier in the project.

This is accomplished by using the <analogy>innerHTML</analogy> property of any HTML element.
